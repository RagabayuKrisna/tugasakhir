      ...
      <div class="col-lg-12">
        <div class="p-5">
          <div class="text-center">
            <h1 class="h4 text-gray-900 mb-4">Edit Tambahan</h1>
          </div>
          <div class="panel panel-default">
              <div class="panel-heading">
                  ...
                  <?php
                        ...
                        $tambahan = new Item();
                        $tampil = $tambahan->read_Id_item($_GET['id_item']);
                  ...
                  <form method='POST'action="" enctype="multipart/form-data">
                      ...
                      <?php
                          if(isset($_POST['btnSimpan'])){
                            ...
                            $debug = $tambahan->update_tambahan($id_item, $nama_pelayanan, $nama_item, $harga_item, $deskripsi, $nama_foto);
                            ...
                            // }else
                            print_r($debug);
                            echo "<script>window.alert('Data Berhasil di ubah'); window.location.replace('index.php?page=tambahan')</script>";
                          }
                      ?>
                  </div>
